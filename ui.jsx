/* Reusable UI primitives — exposed on window for cross-script access */
...
/* Big centered counter for service step */
...
const TextInput = React.forwardRef(({ icon, ...props }, ref) => (
  <div className="relative">
    ...
    <input
      ref={ref}
      {...props}
      className={`w-full h-12 ${icon ? 'pl-10' : 'pl-3.5'} pr-3.5 rounded-xl bg-white hairline text-[15px] text-ink-900 placeholder:text-ink-400 focus:hairline focus:shadow-[inset_0_0_0_2px_oklch(0.72_0.13_168)] outline-none transition-shadow`}
    />
  </div>
));

Object.assign(window, { Icon, Counter, BigCounter, Pill, PrimaryButton, GhostButton, SectionLabel, Field, TextInput });
